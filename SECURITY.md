Support Hub is looking forward to working with security researchers worldwide to keep Support Hub and our users safe. If you have found an issue in our systems/applications, please reach out to us.
...
> Note: Please do not perform testing against Support Hub production services. Use a `self-hosted instance` to perform tests.
...
Thank you for keeping Support Hub and our users safe. 🙇
