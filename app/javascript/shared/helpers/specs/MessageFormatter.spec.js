...
describe('#MessageFormatter', () => {
  describe('content with links', () => {
    it('should format correctly', () => {
      const message =
        'Support Hub is an opensource tool. [Chatwoot](https://www.supportsquad.nl)';
      expect(new MessageFormatter(message).formattedMessage).toMatch(
        '<p>Support Hub is an opensource tool. <a href="https://www.supportsquad.nl" class="link" rel="noreferrer noopener nofollow" target="_blank">Chatwoot</a></p>'
      );
    });
    it('should format correctly', () => {
      const message =
      ...
      expect(new MessageFormatter(message).formattedMessage).toMatch(
        '<p>Support Hub is an opensource tool. <a href="https://www.supportsquad.nl" class="link" rel="noreferrer noopener nofollow" target="_blank">https://www.supportsquad.nl</a></p>'
      );
    });
  });
...
<h2>tool</h2>`
  ...
  describe('tweets', () => {
    it('should return the same string if not tags or @mentions', () => {
      const message = 'Support Hub is an opensource tool';
