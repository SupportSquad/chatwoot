export default {
  ...
  DOCS_URL: '//www.supportsquad.nl/docs/product/',
  HELP_CENTER_DOCS_URL: '//www.supportsquad.nl/docs/product/others/help-center',
  TESTIMONIAL_URL: 'https://testimonials.cdn.supportsquad.nl/content.json',
